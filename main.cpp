...
void mainProcess(cv::Mat input, cv::Mat &output);
...
std::vector<std::vector<double>>sixPointDegreeSequenceIndex = 
{
	...
	{ cos(90 * A2d),cos(90 * A2d),cos(120 * A2d),cos(120 * A2d),cos(120 * A2d),cos(60 * A2d) },
	{ cos(90 * A2d),cos(60 * A2d),cos(120 * A2d),cos(120 * A2d),cos(120 * A2d),cos(90 * A2d) },
	{ cos(120 * A2d),cos(120 * A2d),cos(150 * A2d),cos(90 * A2d),cos(60 * A2d),cos(60 * A2d) }
};
